...
interface ComboboxEditorProps<T> extends ICellEditorParams {
...
function ComboboxEditor<T>(props: ComboboxEditorProps<T>, ref: ForwardedRef<ICellEditor>) {
	...
	return (
		<Autocomplete
			...
			disableClearable
			inputRef={inputRef}
			options={props.options.filter((option) => option !== props.value)}
			value={props.value}
