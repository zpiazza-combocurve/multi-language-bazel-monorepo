...
from cloud_functions.forecast_export.context import ForecastExportContext
...
@with_db
@with_shared_db
@with_context(ForecastExportContext)
@task()
def handle(request, context: ForecastExportContext):
    ...
    return context.forecast_export_service.export_forecast(**export_service_params,
                                                           settings=settings,
