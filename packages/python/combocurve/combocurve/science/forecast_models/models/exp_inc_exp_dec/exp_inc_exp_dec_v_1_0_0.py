...
from combocurve.science.segment_models.shared.helper import exp_D_eff_2_D, pred_exp, exp_D_2_D_eff, exp_get_D
from combocurve.science.forecast_models.shared.segment_shared import exp_para_2_seg, get_exp_inc_seg


class model_exp_inc_exp_dec(model_segment_arps_4_parent):
    def __init__(self):
        self.model_name = 'exp_inc_exp_dec'
        self.model_p_name = ['q0', 'D']  #dca_plugin
        self.model_p_fixed_name = ['t_first', 'minus_t0_t_first', 'minus_t_peak_t0', 'q_peak']  #dca_plugin
    ...
    def func(self, t, p, p_fixed):
        ...
        ret_list[range_1] = pred_exp(t[range_1], t_peak, q_peak, D)
        return ret_list
    ...
    def prepare(self, data, t_peak, transformation, p2seg_dict=None):
        ...
        p_range = [(q0_left, q_peak), (1e-6, 10)]
    ...
    def p2seg(self, p, p_fixed, p2seg_dict):
        ...
        exp_dec_seg = exp_para_2_seg(t_end_life, end_data_idx, q_final, D_eff, t_peak, q_peak)
        ret += exp_dec_seg
