...
from combocurve.science.forecast_models.shared.prob_shared import (one_seg_arps_para_candidates,
                                                                   pred_arps_wp_para_candidates)
...
class model_arps_modified_free_peak(model_parent):
    def __init__(self):
        self.model_name = 'arps_modified_free_peak'
    ...
    def ml_adjust_P_dict(self, ap_data, det, t_peak, use_para_dict, ret_P_dict):
        ...
        [P10_D_eff, P10_b, P10_q_peak] = ret_P_dict['P10']['p']
        [P50_D_eff, P50_b, P50_q_peak] = ret_P_dict['P50']['p']
        [P90_D_eff, P90_b, P90_q_peak] = ret_P_dict['P90']['p']
        if ap_data.shape[0] <= 1:
            ...
            best_fit_p, best_fit_p_fixed = det.get_params(ap_data,
                                                          ...
                                                          ranges=det_range)
            [best_fit_D_eff, best_fit_b, best_fit_q_peak] = best_fit_p
            ####
    ...
    def pred_para_candidates(self, t, p_table, p_fixed_table, para_dict, data_end_idx, t_end_life):
        q_peak = p_table[:, 2].reshape(-1, 1)
        p_table = np.delete(p_table, 2, 1)
        p_fixed_table = np.append(p_fixed_table, q_peak, 1)
