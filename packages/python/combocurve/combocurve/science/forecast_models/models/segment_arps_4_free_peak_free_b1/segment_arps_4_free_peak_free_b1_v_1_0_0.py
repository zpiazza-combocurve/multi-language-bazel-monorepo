...
class model_segment_arps_4_free_peak_free_b1(model_segment_arps_4_parent):
    def __init__(self):
        self.model_name = 'segment_arps_4_free_peak_free_b1'
        self.model_p_name = ['q0', 'D1_eff', 'b1', 'minus_t_elf_t_peak', 'b2', 'D2_eff', 'q_peak']
    ...
    def func(self, t, p, p_fixed):
        [q0, D1_eff, b1, minus_t_elf_t_peak, b2, D2_eff, q_peak] = p
    ...
    def TC_set_before_peak(self, p, p_fixed):
        ...
        t_first = params['t_first']
        minus_t0_t_first = params['minus_t0_t_first']
        minus_t_peak_t0 = params['minus_t_peak_t0']
        ...
        t0 = t_first + minus_t0_t_first
        t_peak = t0 + minus_t_peak_t0
        t_elf = t_peak + params['minus_t_elf_t_peak']
        D1 = arps_D_eff_2_D(params['D1_eff'], params['b1'])
        q2 = pred_arps(t_elf, t_peak, q_peak, D1, params['b1'])
        D2 = q_peak / q2 * D1 * np.power(1 + params['b1'] * D1 * (t_elf - t_peak), -(1 / params['b1'] + 1))
        params['D2_eff'] = arps_D_2_D_eff(D2, params['b2'])

        ret_p, ret_p_fixed = self.get_p_p_fixed_from_dict(params)
