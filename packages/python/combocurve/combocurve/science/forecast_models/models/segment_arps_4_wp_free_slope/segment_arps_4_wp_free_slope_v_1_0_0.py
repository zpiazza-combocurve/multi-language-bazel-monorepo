...
class model_segment_arps_4_wp_free_slope(model_parent):
    def __init__(self):
        self.model_name = 'segment_arps_4_wp_free_slope'
        self.model_p_name = ['q0', 'D1_eff', 'minus_t_elf_t_peak', 'D2_eff', 'b2']
        ...
        self.TC_c8_para_name = ['q_peak', 'D1_eff', 'b2', 'D2_eff']
    ...
    def func(self, t, p, p_fixed):
        [q0, D1_eff, minus_t_elf_t_peak, D2_eff, b2] = p
    ...
    def prepare(self, data, t_peak, transformation, p2seg_dict=None):
        ...
        p_range = [(q0_left, q_peak), (1e-5, 1 - 1e-5), (0, np.max(transformed_data[:, 0]) - t_peak), (1e-5, 1 - 1e-5),
                   (1e-5, 2)]
