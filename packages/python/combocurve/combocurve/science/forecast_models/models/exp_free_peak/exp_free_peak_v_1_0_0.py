...
class model_exp_free_peak(model_parent):
    def __init__(self):
        self.model_name = 'exp_free_peak'
        self.model_p_name = ['D_eff', 'q_peak']  #dca_plugin
    ...
    def p2seg(self, p, p_fixed, p2seg_dict):
        ...
        [t_first, minus_t_peak_t_first] = p_fixed
        t_peak = t_first + minus_t_peak_t_first
        return exp_para_2_seg(t_end_life, t_end_data, q_final, D_eff, t_peak, q_peak)
