...
class model_exp_inc_exp_dec_free_peak(model_segment_arps_4_parent):
    def __init__(self):
        self.model_name = 'exp_inc_exp_dec_free_peak'
        self.model_p_name = ['q0', 'D', 'q_peak']  # HACK: there is a None here to pad the q_peak to pos 3.
