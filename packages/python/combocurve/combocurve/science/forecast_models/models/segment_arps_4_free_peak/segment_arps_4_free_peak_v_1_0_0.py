...
class model_segment_arps_4_free_peak(model_segment_arps_4_parent):
    def __init__(self):
        self.model_name = 'segment_arps_4_free_peak'
        self.model_p_name = ['q0', 'D1_eff', 'minus_t_elf_t_peak', 'b2', 'q_peak']
    ...
    def func(self, t, p, p_fixed):
        [q0, D1_eff, minus_t_elf_t_peak, b2, q_peak] = p
