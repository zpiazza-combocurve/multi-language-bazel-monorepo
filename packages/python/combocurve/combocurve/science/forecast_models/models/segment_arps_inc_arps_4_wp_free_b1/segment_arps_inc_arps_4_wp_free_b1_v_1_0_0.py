...
class model_segment_arps_inc_arps_4_wp_free_b1(model_segment_arps_4_parent):
    def __init__(self):
        self.model_name = 'segment_arps_inc_arps_4_wp_free_b1'
        self.model_p_name = ['q0', 'D1_eff', 'b1', 'minus_t_elf_t_peak', 'b2', 'b0']
    ...
    def func(self, t, p, p_fixed):
        [q0, D1_eff, b1, minus_t_elf_t_peak, b2, b0] = p
