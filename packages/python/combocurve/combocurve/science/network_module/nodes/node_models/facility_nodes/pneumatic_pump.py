...
def calculate_pneumatic_pump(node_data, well_count_arr: Int32NDArray, date: MonthlyFrequencyDatetime64mNDArray):
    """Calculates emissions from pneumatic device node.
    Note: compared to pneumatic device, time series data of this does not have device_type field, always use 'pump'
    Arguments:
    ...
    """
    return pneumatic_time_series_facility_emission(node_data, well_count_arr, date, False)
