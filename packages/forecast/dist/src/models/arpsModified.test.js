...
describe('SegmentModels-ArpsModifiedSegment', () => {
    const arpsModified1 = new arpsModified_1.default({
        end_idx: 41541,
        name: 'arps_modified',
        start_idx: 39716,
        b: 1.2,
    ...
    test('ArpsModifiedSegment-changeQStart', () => {
        ...
        expect(arpsModified1.changeQStart(2000).q_end).toBeCloseTo(arpsModified1.segment.q_end * (2000 / arpsModified1.segment.q_start));
        expect(arpsModified1.changeQStart(2000).q_sw).toBeCloseTo(arpsModified1.segment.q_sw * (2000 / arpsModified1.segment.q_start));
    });
