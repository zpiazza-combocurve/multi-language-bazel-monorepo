import ExpIncSegment from './expInc';

describe('SegmentModels-ExpIncSegment', () => {
	const expIncSegment1 = new ExpIncSegment({
		end_idx: 41541,
		name: 'exp_inc',
		start_idx: 39716,
		D: -0.001,
	...
	const expIncSegment2 = new ExpIncSegment({
		end_idx: 43367,
		name: 'exp_inc',
		start_idx: 41542,
	...
	test('ExpIncSegment-changeQStart', () => {
		...
		expect(expIncSegment1.changeQStart(2000).q_end).toBeCloseTo(
			expIncSegment1.segment.q_end * (2000 / expIncSegment1.segment.q_start)
		);
	});
	...
	test('ExpIncSegment-changeDuration', () => {
		...
		expect(expIncSegment1.changeDuration(44327 - expIncSegment1.segment.start_idx + 1).q_end).toBeCloseTo(
			10485.99671821605
		);
	});
	...
	test('ExpIncSegment-buttonConnectPrev', () => {
		expect(expIncSegment2.buttonConnectPrev(expIncSegment1.segment).q_start).toBeCloseTo(
			expIncSegment1.segment.q_end
		);
		expect(expIncSegment2.buttonConnectPrev(expIncSegment1.segment).q_end).toBeCloseTo(
			(expIncSegment2.segment.q_end * expIncSegment1.segment.q_end) / expIncSegment2.segment.q_start
		);
	});
	...
	test('ExpIncSegment-buttonConnectNext', () => {
		...
		expect(expIncSegment1.buttonConnectNext(expIncSegment2.segment).q_start).toBeCloseTo(
			(expIncSegment1.segment.q_start * expIncSegment2.segment.q_start) / expIncSegment1.segment.q_end
		);
	});
	...
	test('ExpIncSegment-calcQStart', () => {
		...
		).toBeCloseTo(104.25043154224356);
		expect(
			expIncSegment2.calcQStart({
				start_idx: 41542,
				end_idx: 43367,
				q_start: 2332.301779425153,
				q_end: 74456.82327023758,
		...
		).toBeCloseTo(2332.301779425153);
	});

	test('ExpIncSegment-calcEndIdx', () => {
		expect(
			expIncSegment1.calcEndIdx({
				start_idx: 39716,
				end_idx: 41541,
				q_start: 104.25043154224356,
				q_end: 646.6440575097611,
	...
	test('ExpIncSegment-calcQEnd', () => {
		...
		).toBeCloseTo(646.6440575097611);
		expect(
			expIncSegment2.calcQEnd({
				start_idx: 41542,
				end_idx: 43367,
				q_start: 2332.301779425153,
				q_end: 74456.82327023758,
		...
		).toBeCloseTo(74456.82327023758);
	});

	test('ExpIncSegment-calcDeff', () => {
		expect(
			expIncSegment1.calcDeff({
				start_idx: 39716,
				end_idx: 41541,
				q_start: 104.25043154224356,
				q_end: 646.6440575097611,
		...
		).toBeCloseTo(-0.44087418167106884);
		expect(
			expIncSegment2.calcDeff({
				start_idx: 41542,
				end_idx: 43367,
				q_start: 2332.301779425153,
				q_end: 74456.82327023758,
