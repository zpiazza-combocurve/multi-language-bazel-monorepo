...
describe('SegmentModels-ArpsSegment', () => {
    const arps1 = new arps_1.default({
        end_idx: 42327,
        name: 'arps',
        start_idx: 40502,
        b: 0.9,
    ...
    const arps2 = new arps_1.default({
        end_idx: 44153,
        name: 'arps',
        start_idx: 42328,
        b: 0.9,
    ...
    (0, globals_1.test)('ArpsSegment-changeQStart', () => {
    ...
    (0, globals_1.test)('ArpsSegment-changeQEnd', () => {
    ...
    (0, globals_1.test)('ArpsSegment-changeDeff', () => {
    ...
    (0, globals_1.test)('ArpsSegment-changeB', () => {
    ...
    // });
    (0, globals_1.test)('ArpsSegment-buttonConnectPrev', () => {
        expect(arps2.buttonConnectPrev(arps1.segment).q_start).toBe(arps1.segment.q_end);
        expect(arps2.buttonConnectPrev(arps1.segment).q_end).toBeCloseTo((arps2.segment.q_end * arps1.segment.q_end) / arps2.segment.q_start);
    });
    (0, globals_1.test)('ArpsSegment-buttonConnectNext', () => {
        expect(arps1.buttonConnectNext(arps2.segment).q_end).toBe(arps2.segment.q_start);
        expect(arps1.buttonConnectNext(arps2.segment).q_start).toBeCloseTo((arps1.segment.q_start * arps2.segment.q_start) / arps1.segment.q_end);
    });
    (0, globals_1.test)('ArpsSegment-buttonAnchorPrev', () => {
    ...
    (0, globals_1.test)('ArpsSegment-buttonAnchorNext', () => {
    ...
    (0, globals_1.test)('ArpsSegment-buttonMatchSlope', () => {
