...
exports.getConvertFunc = exports.getUnitNomDenomLists = void 0;
...
function getUnitNomDenomLists(unitStr) {
...
exports.getUnitNomDenomLists = getUnitNomDenomLists;
 ...
 */
function getConvertFunc(origUnit, targetUnit) {
    if (!origUnit || !targetUnit) {
        return (v) => v;
    }
...
exports.getConvertFunc = getConvertFunc;
