...
// eslint-disable-next-line @typescript-eslint/no-var-requires -- TODO eslint fix later
const { up } = require('./20210617185000-set-first-prod-date-daily-when-wrong');
...
const wellsBefore = [
	...
	},
	{
		...
		has_daily: true,
		first_prod_date_daily_calc: new Date('2000-01-02'),
	},
	{
		_id: new ObjectId('123456789012345678900004'),
		has_daily: true,
		first_prod_date_daily_calc: new Date('2021-02-28'),
	},
	{
		_id: new ObjectId('123456789012345678900005'),
		has_daily: true,
		first_prod_date_daily_calc: new Date('1990-08-01'),
	},
];
const wellsAfter = [
	{ _id: new ObjectId('123456789012345678900001'), has_daily: false, first_prod_date_daily_calc: null },
...
describe('20210617185000-set-first-prod-date-daily-when-wrong', () => {
	let wellsCollection;
